...
import EmployeeOrderHeader from './components/EmployeeOrderHeader.vue';
...
<template>
    <template v-if="state.step == 1">
        <EmployeeOrderHeader :step_number="1" />
    ...
    <template v-else-if="state.step == 2">
        <EmployeeOrderHeader :step_number="2" />
    ...
    <template v-else-if="state.step == 3">
        <EmployeeOrderHeader :step_number="3" />
    ...
    <template v-else-if="state.step == 4">
        <EmployeeOrderHeader :step_number="4" />
